...
def build_prompt(question, context, time_context, history):
    ...
    prompt = (
        ...
        "Give one clear, complete answer rather than just 'yes' or 'no' — a bit of explanation is good, "
        "but keep it fairly tight; don't pad the answer with extra analysis, restate the question, or "
        "over-elaborate beyond what's needed to actually answer it.\n"
        "Do not add extra questions, extra answers, or unrelated text beyond your one answer.\n"
